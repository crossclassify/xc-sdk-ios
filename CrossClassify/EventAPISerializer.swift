    ...
    var queryItems: [URLQueryItem] {
        get {
            ...
            let items = [
                ...
                URLQueryItem(name: "_uid", value: visitor.userId),
                ...
                URLQueryItem(name: "fa_vid", value: fa_vid),
                URLQueryItem(name: "pv_id", value: pv_id),
                URLQueryItem(name: "fa_name", value: fa_name),
                URLQueryItem(name: "fa_id", value: fa_id),
                URLQueryItem(name: "fa_su", value: fa_su != nil ? "\(fa_su!)" : nil),
            ]
            ...
            let formFieldsItems = fa_fields.count > 0 ? [URLQueryItem(name: "fa_fields", value: String(data: try! JSONEncoder().encode(fa_fields), encoding: .utf8))] : []
        
            let all_items = items + dimensionItems + ecommerceOrderItemsAndFlag + customVariableItems + customItems + formFieldsItems
            print("request: ",all_items)
            return all_items
        }
    }
}
