...
final public class MatomoTracker: NSObject {
    ...
    required public init(siteId: String, queue: Queue, dispatcher: Dispatcher, apiKey: String) {
        self.siteId = siteId
        self.queue = queue
        self.apiKey = apiKey
    ...
    @objc convenience public init(siteId: String, baseURL: URL, userAgent: String? = nil, apiKey: String) {
        ...
        let dispatcher = URLSessionDispatcher(baseURL: baseURL, userAgent: userAgent, apiKey: apiKey)
        
        self.init(siteId: siteId, queue: queue, dispatcher: dispatcher, apiKey: apiKey)
    }
...
extension MatomoTracker {
    ...
    public func trackPage(view: [String], url: URL? = nil, dimensions: [CustomDimension] = [], pv_id: String? = nil) {
        let event = Event(tracker: self, action: view, url: url, dimensions: dimensions, isCustomAction: false, pv_id: pv_id)
        queue(event: event)
    }
    ...
    public func trackForm(items: [FormField], fa_vid: String?, pv_id: String?, fa_name: String, fa_id: String, fa_su: Int, fa_ef: String?, fa_lf: String?, fa_ts: Int?, fa_ht: Int?, fa_st: Int?, fa_tts: Int?) {
        let event = Event(tracker: self, action: [], isCustomAction: false, fa_fields: items, fa_vid: fa_vid, pv_id: pv_id, fa_name: fa_name, fa_id: fa_id, fa_su: fa_su, fa_ef: fa_ef, fa_lf: fa_lf, fa_ts: fa_ts, fa_ht: fa_ht, fa_st: fa_st, fa_tts: fa_tts)
        queue(event: event)
    }
}
